...
## Acknowledgment
- [ORBISPatches](https://orbispatches.com/) for there amazing work in archiving PlayStation 4 games, which is used by this script to resolve a game ID to a name and image
